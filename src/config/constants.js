...
const MAX_CONNECTIONS = parseInt(process.env.MAX_CONNECTIONS) || 32;

const HEARTBEAT_INTERVAL = parseInt(process.env.HEARTBEAT_INTERVAL) || 5000;
const CONNECTION_ROTATION_INTERVAL = parseInt(process.env.CONNECTION_ROTATION_INTERVAL) || 30000;
const PEER_TIMEOUT = parseInt(process.env.PEER_TIMEOUT) || 15000;
